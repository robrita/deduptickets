    ...
    <div className="page-container">
      ...
      <div className="mb-6">
        <div className="flex items-center gap-2">
          <span className="text-sm font-medium text-navy-700 dark:text-[var(--color-text-secondary)]">
            Filter:
          </span>
              ...
              <button
                ...
                className={`px-4 py-2 text-sm font-medium border ${
                  filterStatus === option.value
                    ...
                    : 'bg-white text-navy-700 border-navy-300 hover:bg-navy-50 dark:bg-[var(--color-surface-card)] dark:text-[var(--color-text-secondary)] dark:border-[var(--color-border)] dark:hover:bg-[var(--color-surface-alt)]'
                } ${
                  option.value === 'all'
                    ? 'rounded-l-md'
      ...
      {isLoading ? (
        ...
        /* Empty state */
        <div className="text-center py-12 bg-white rounded-lg border border-navy-200 dark:bg-[var(--color-surface-card)] dark:border-[var(--color-border)]">
          <svg
            className="mx-auto h-12 w-12 text-navy-600 dark:text-[var(--color-text-secondary)]"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
          ...
          <h3 className="mt-2 text-sm font-medium text-navy-900 dark:text-[var(--color-text)]">
            No merge operations
          </h3>
